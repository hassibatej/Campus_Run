...
//Marie-Alexis worked on sound in this file (with Antoine Majoie)
...
void SettingsState::initKeybinds()
{
	...
	if (ifs.is_open())
	{
		...
		buffer5.loadFromFile("Images_and_Audio/Audio/mm17_1.wav"); // implementing the song
		song2.setBuffer(buffer5);
		song2.play(); // playing the song
...
void SettingsState::initGui()
{
	...
	if (!this->backgroundTexture.loadFromFile("Images_and_Audio/Images/bg1.png"))
	{
